...
* @see https://v0.dev/t/ir8AXp0whrV
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>The total number of products available on the platform.</CardDescription>
              </CardHeader>
              <CardContent className="flex items-center justify-between">
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card>
              <CardHeader>
                ...
                <CardDescription>A chart showing the sales trends over the past 6 months.</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>A table showing the top selling products on the platform.</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>A table showing the most recent orders placed on the platform.</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
